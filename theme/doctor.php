...
// $salectAllQuery = " SELECT * FROM `doctors` ";

// $FetchsalectAllQuery = $connection->prepare($salectAllQuery);
// $FetchsalectAllQuery->execute();
// $FetchsalectAllQueryData =  $FetchsalectAllQuery->fetchAll(PDO::FETCH_ASSOC);



// print_r($FetchsalectAllQueryData);
