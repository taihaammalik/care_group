...
if(isset($_POST['login']))
{
	...
	{
		echo "<script>alert('kindly fill All This input fields!')</script>";
	}
	else
	{
		$logininsertquery = "INSERT INTO `admin/doctors & users login`(`email`, `password`) VALUE(:email,:password)";

    //    $logininsertqueryprepare = $connection->prepare($logininsertquery);

	//    $logininsertqueryprepare->bindParam(':email', $email);
	//    $logininsertqueryprepare->bindParam(':password', $password);
	//    $logininsertqueryprepare->execute();
...
$fetchRegistertedPrepare = $connection->prepare($fetchRegisteredUser);
$fetchRegistertedPrepare->execute();

$fetchRegisteredData = $fetchRegistertedPrepare->fetchAll(PDO::FETCH_ASSOC);
 
// print_r($fetchRegisteredData);
...
// 	foreach ($fetchRegisteredData as $userData) 
// 	{
			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="appoinment.php" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">login-Form<i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-12 m-5 container">
				<div class="mt-5 mt-lg-0">
					<h2 class="text-center mb-2 title-color">User Login</h2>

					     <form action="login.php" class="appoinment-form " method="post" >
                    <div class="row">
                         <div class="col-lg-12">
                    ...
                    <a href="appoinment.php"><input class="btn btn-main btn-round-full" type="submit" name="login"></input></a>
			...
			<!-- <div class="col-lg-6 col-md-10 ">
				<div class="appoinment-wrap mt-5 mt-lg-0">
					<h2 class="mb-2 title-color">login-Form</h2>
					     <form class="login-form" method="post" action="appoinment.php">
                    <div class="row">
                         <div class="col-lg-6">
                            <div class="form-group">
                                <input name="email"  type="email" class="form-control" placeholder="Enter Your Email">
					...
					<input class="btn btn-main btn-round-full" type="submit" name="login"></input>
